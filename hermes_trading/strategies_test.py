...
TEST_STRATEGIES = [
    ...
    {
        "id": "vwap_trend",
        "name": "VWAP Trend Trading ⭐ RESEARCH",
        "description": "Crypto-adapted VWAP Trend Trading from Zarattini & Aziz (2023), SSRN 4631351. Long above session VWAP, short below. Paper: 671% / Sharpe 2.1 / MDD 9.4% on QQQ. 15m candles, UTC-daily-anchored VWAP.",
        "budget": 25.0,
        "strategy": {
            **BASE,
            "version": "vwap-v1",
            "entry_threshold": 0.10,
            "signal_weights": {"rsi": 0.0, "sentiment": 0.0, "onchain": 0.0, "macro": 0.0},
            "stop_loss_pct": 3.0,
            "take_profit_multiple": 3.0,
            "use_atr_stops": False,
            "use_trend_filter": False,
            ...
            "tick_seconds": 30,
            "use_vwap": True,
            "vwap_min_distance_pct": 1.5,
            "risk_per_trade_pct": 0.75,
            "position_size_r": 0.20,
            "max_concurrent_positions": 3,
        },
    },
]
